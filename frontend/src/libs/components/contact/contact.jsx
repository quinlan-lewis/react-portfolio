            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4 bg-white/10 p-6 rounded-2xl backdrop-blur-sm border border-white/20">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Quinlan.Lewis@colorado.edu</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 bg-white/10 p-6 rounded-2xl backdrop-blur-sm border border-white/20">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Denver, CO</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-white/10 p-8 rounded-2xl backdrop-blur-sm border border-white/20">
                ...
                <div className="space-y-4">                  
                  <a href="https://www.linkedin.com/in/quinlan-lewis-1749971b6/" className="flex items-center space-x-4 p-4 bg-white/10 rounded-xl hover:bg-white/20 transition-all duration-300">
                  ...
                  <a href="https://github.com/quinlan-lewis" className="flex items-center space-x-4 p-4 bg-white/10 rounded-xl hover:bg-white/20 transition-all duration-300">
